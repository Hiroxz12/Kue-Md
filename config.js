let fs = require('fs')
global.owner = JSON.parse(fs.readFileSync('085732267014')) // Put your number to folder /src/owner.json
global.mods = JSON.parse(fs.readFileSync('085732267014')) // Want some help?
